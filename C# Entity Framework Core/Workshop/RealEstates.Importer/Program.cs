namespace RealEstates.Importer
{
    ...
    public class Program
    {
        ...
        private static void ImportJsonFile(string fileName)
        {
            ...
            {
                propertiesService.Add(jsonProp.District, jsonProp.Floor, jsonProp.TotalFloors,
                    jsonProp.Size, jsonProp.YardSize, jsonProp.Year,
                    jsonProp.Type, jsonProp.BuildingType, jsonProp.Price);
